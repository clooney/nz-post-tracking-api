NZ Post Tracking API - Node.js
================================
Use Node.js to track NZ Post shipments with NZ Post Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"new-zealand-post"},{"tracking_number" => "LH290032509AU","courier_code"=>"new-zealand-post"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"new-zealand-post"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"new-zealand-post"}
