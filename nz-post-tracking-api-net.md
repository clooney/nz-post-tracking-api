NZ Post Tracking API - .Net
================================
Use .Net to track NZ Post shipments with NZ Post Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.courierCode = "new-zealand-post";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  getTrackingResultsParams.courierCode = "new-zealand-post";
