NZ Post Tracking API - Java
================================
Use Java to track NZ Post shipments with NZ Post Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.newzealandpost;
    ...
    public class CreateNewZealandPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("new-zealand-post");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateNewZealandPostTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetNewZealandPostTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("new-zealand-post");
...
Update a tracking by ID:
    ...
    public class UpdateNewZealandPostTrackingExample {
